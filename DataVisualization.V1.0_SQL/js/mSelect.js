...
/*	var aS=document.getElementsByTagName('select');
	...
	mySelect.Create(document.getElementById("DropDownList1"),'blueCircle',true);
	mySelect.Create(document.getElementById("DropDownList2"),'blueCircle',true);
	mySelect.Create(document.getElementById("DropDownList3"),'blueCircle',true);
}
