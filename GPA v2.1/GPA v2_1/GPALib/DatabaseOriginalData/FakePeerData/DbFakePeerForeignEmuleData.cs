...
{
    class DbFakePeerForeignEmuleData : DbServerDataBase
    {
        public DbFakePeerForeignEmuleData(ref DbBase dbBase, DateTime beginTime, DateTime endTime, bool isPartition) :
