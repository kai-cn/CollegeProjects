...
{
    class DbFakePeerInternalBtData:DbFakePeerDataBase
    {

        public DbFakePeerInternalBtData(ref DbBase dbBase, DateTime beginTime, DateTime endTime, bool isPartition) :
