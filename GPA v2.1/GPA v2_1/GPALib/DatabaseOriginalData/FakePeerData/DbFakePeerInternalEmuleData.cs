...
{
    class DbFakePeerInternalEmuleData:DbFakePeerDataBase
    {
        public DbFakePeerInternalEmuleData(ref DbBase dbBase, DateTime beginTime, DateTime endTime, bool isPartition) :
