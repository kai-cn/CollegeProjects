...
{
    class DbBlockListForeignBtData:DbBlockListDataBase
    {
        public DbBlockListForeignBtData(ref DbBase dbBase, DateTime beginTime, DateTime endTime, bool isPartition) :
        ...
        protected override string GetCommand()
        {
            ...
            else
            {
                ...
                strSql = string.Format(@"select distinct type_blocklist,ip from ip_map_geolocation_foreign_bt
