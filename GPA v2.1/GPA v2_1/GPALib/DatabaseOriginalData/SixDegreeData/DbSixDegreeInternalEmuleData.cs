...
{
    class DbSixDegreeInternalEmuleData:DbSixDegreeDataBase
    {
        public DbSixDegreeInternalEmuleData(ref DbBase dbBase, DateTime beginTime, DateTime endTime, bool isPartition) :
        ...
        protected override string GetCommand()
        {
            ...
            else
            {
                    strSql = string.Format(@"select distinct resource_uri,server_ip,{0}
                     from {1}  where type='em' and peer_source='SX' and asciistr(resource_uri) like '%\%'
