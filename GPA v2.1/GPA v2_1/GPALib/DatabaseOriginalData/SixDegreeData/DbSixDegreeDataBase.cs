...
{
    abstract class DbSixDegreeDataBase:DbOriginalDataBase
    {
        protected List<ADT.OriginalDataUnit> _originalDataLists;


        public DbSixDegreeDataBase(ref DbBase dbBase, DateTime beginTime, DateTime endTime, bool isPartition) :
            ...
            if (ds != null)
            {
                ...
                try
                {
                    ...
                    foreach (DataRow dr in ds.Tables[0].Rows)
                    {
                        ...
                        unit.resource_uri = dr[0].ToString();
                        unit.server_ip = dr[1].ToString();
                        unit.ip = dr[2].ToString();
