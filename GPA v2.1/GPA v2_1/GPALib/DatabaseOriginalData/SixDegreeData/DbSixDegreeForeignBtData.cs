...
{
    class DbSixDegreeForeignBtData:DbSixDegreeDataBase
    {
        public DbSixDegreeForeignBtData(ref DbBase dbBase, DateTime beginTime, DateTime endTime, bool isPartition) :
        ...
        protected override string GetCommand()
        {
            ...
            else
            {
                strSql = string.Format(@"select distinct resource_uri,server_ip,{0}
                     from {1}  where type='bt' and peer_source='SX'  and  regexp_instr(resource_uri,'_')<>0
