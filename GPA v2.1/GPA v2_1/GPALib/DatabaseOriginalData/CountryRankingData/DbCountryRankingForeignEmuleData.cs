...
{
    class DbCountryRankingForeignEmuleData:DbCountryRankingDataBase
    {
        public DbCountryRankingForeignEmuleData(ref DbBase dbBase, DateTime beginTime, DateTime endTime, bool isPartition) :
        ...
        protected override string GetCommand()
        {
            ...
            else
            {
                strSql = string.Format(@"select distinct {0} 
                    ...
                    and asciistr(resource_uri) not like '%\%'"
