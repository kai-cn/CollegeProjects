...
{
    abstract class DbCountryRankingDataBase:DbOriginalDataBase
    {
        protected List<ADT.OriginalDataUnit> _originalDataLists;


        public DbCountryRankingDataBase(ref DbBase dbBase, DateTime beginTime, DateTime endTime, bool isPartition) :
        ...
        public override object GetOriginalData()
        {
            ...
            if (ds != null)
            {
                ...
                try
                {
                    ...
                    {
                        _originalDataLists.Add(new ADT.OriginalDataUnit(dr[0].ToString()));
                        if (i++ % 5000 == 0)
                            Thread.Sleep(200);
                    }
                }
