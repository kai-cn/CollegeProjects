...
{
    class DbDayLightEffectForeignEmuleData:DbDayLightEffectDataBase
    {

        public  DbDayLightEffectForeignEmuleData(ref DbBase dbBase, DateTime beginTime, DateTime endTime, bool isPartition) :
        ...
        protected override string GetCommand()
        {
            ...
            else
            {
                ...
                strSql = string.Format(@"select distinct insertion_time,{0}
                     from {1}  where type='em' and asciistr(resource_uri) not like '%\%'
