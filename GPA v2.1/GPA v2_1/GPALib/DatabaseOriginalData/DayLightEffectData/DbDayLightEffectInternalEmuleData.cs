...
{
    class DbDayLightEffectInternalEmuleData:DbDayLightEffectDataBase
    {
        public  DbDayLightEffectInternalEmuleData(ref DbBase dbBase, DateTime beginTime, DateTime endTime, bool isPartition) :
        ...
        protected override string GetCommand()
        {
            ...
            {
                strSql = string.Format(@"select insertion_time,{0}
                     from {1}  where type='em' and asciistr(resource_uri) like '%\%'
