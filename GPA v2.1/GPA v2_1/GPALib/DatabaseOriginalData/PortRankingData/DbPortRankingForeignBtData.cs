...
{
    class DbPortRankingForeignBtData:DbPortRankingDataBase
    {
        public DbPortRankingForeignBtData(ref DbBase dbBase, DateTime beginTime, DateTime endTime, bool isPartition) :
