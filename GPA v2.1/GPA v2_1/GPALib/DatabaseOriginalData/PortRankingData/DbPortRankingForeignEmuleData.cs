...
{
    class DbPortRankingForeignEmuleData:DbPortRankingDataBase
    {
        public DbPortRankingForeignEmuleData(ref DbBase dbBase, DateTime beginTime, DateTime endTime, bool isPartition) :
