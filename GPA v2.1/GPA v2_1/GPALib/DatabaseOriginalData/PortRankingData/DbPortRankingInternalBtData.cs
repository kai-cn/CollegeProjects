...
{
    class DbPortRankingInternalBtData:DbPortRankingDataBase
    {
        public DbPortRankingInternalBtData(ref DbBase dbBase, DateTime beginTime, DateTime endTime, bool isPartition) :
